...
*The premier tech event and hackathon platform, connecting students with industry leaders and innovators.*
...
| Feature | Description |
|---------|-------------|
| 🎨 **Modern UI** | Sleek dark theme with golden accents |
...
| Color | HSL | Usage |
|-------|-----|-------|
| **Gold** | `43 80% 55%` | Primary accents, highlights |
| **Dark Background** | `20 10% 8%` | Main background |
| **Light Text** | `40 30% 85%` | Cards, text |
